  ...
  return (
    <section className='my-28  px-5'>
      ...
      <div className='my-7 grid gap-5 grid-cols-3 md:grid-cols-6'>
        ...
        <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='MongoDB'>
          <img src='./images/icons/sql.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
         Mysql
        </div>
        ...
        <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='CSS 3'>
          <img src='./images/icons/Bootstrap_logo.svg.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
         Bootstrap
        </div>
        <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='CSS 3'>
          <img src='./images/icons/mui.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
        Material UI
        </div>
        <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='CSS 3'>
          <img src='./images/icons/git.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
       GitHub
        </div>
        <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='CSS 3'>
          <img src='./images/icons/vs.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
     Vs Code
        </div>
      </div>
